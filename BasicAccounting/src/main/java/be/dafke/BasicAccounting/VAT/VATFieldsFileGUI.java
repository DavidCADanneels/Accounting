 ...
 */
public class VATFieldsFileGUI extends JFrame {
    private static final HashMap<VATFields, VATFieldsFileGUI> editableVatGuis = new HashMap<>();
...
//    public static final String SALES_AT_12 = "Sales at 12%";
    ...
    public static VATFieldsFileGUI getInstance(VATFields vatFields) {
        VATFieldsFileGUI gui;
        gui = editableVatGuis.get(vatFields);
        if(gui==null){
            gui = new VATFieldsFileGUI(vatFields);
    ...
    private VATFieldsFileGUI(VATFields vatFields) {
