...
public class ArticlesDetailsDataTableModel extends SelectableTableModel<Article> {
	...
	public ArticlesDetailsDataTableModel(Component parent, Articles articles) {
		this.parent = parent;
