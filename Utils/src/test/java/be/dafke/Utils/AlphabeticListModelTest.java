...
public class AlphabeticListModelTest {
    ...
    @Test
    public void addReversedOrder(){
        createReversedList();
        assertOrder();
    }

    @Test
    public void insertFirstHalf(){
        createNormalList();
    ...
    @Test
    public void addDuplicateOfFirstElement(){
        createNormalList();
    ...
    @Test
    public void addDuplicateOfRandomElement(){
        createNormalList();
    ...
    @Test
    public void addDuplicateOfLastElement(){
        createNormalList();
    ...
    @Test
    public void addNewDuplicateBeforeOriginal(){
        model.addElement(AAP);
